...
const GROQ_API_KEY = import.meta.env.VITE_GROQ_API_KEY; // stored securely in Cloudflare
        ...
        {tab === "planner" && (
          <div className="flex flex-col gap-4 items-center">
            ...
            <div className="w-full overflow-x-auto mt-4">
              {outline.map((w) => (
                <div key={w.week} className="mb-2 border p-2 rounded">
        ...
        {tab === "studio" && (
          <div className="flex flex-col gap-4 items-center">
            <canvas
              ...
              width={1280}
              height={720}
              className="w-full bg-black rounded-xl shadow-lg"
            />
            {recording && (
          ...
          <div className="flex flex-col gap-2 items-center">
            ...
            {thumbnailURL && (
              <img
                ...
                className="w-full max-w-sm rounded shadow-lg mt-2"
              />
            )}
            {error && <p className="text-red-600 mt-2">{error}</p>}
          </div>
        ...
        {tab === "library" && (
          <div className="flex flex-col gap-2">
            {clips.length === 0 ? (
              ...
              clips.map((c, i) => (
                <video key={i} src={c} controls className="w-full rounded" />
              ))
            )}
          </div>
        )}
